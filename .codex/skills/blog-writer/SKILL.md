...
description: |
  ...
  文体・トーン・品質判断は .codex/agents/blog-writer.md の職種定義に従うこと。
...
文体・トーン・品質の判断基準は `.codex/agents/blog-writer.md` の職種定義を参照すること。
...
**文体・トーン・執筆原則は `.codex/agents/blog-writer.md` の職種定義に従うこと。**
...
ファクトチェックの原則は `.codex/agents/blog-writer.md` の職種定義を参照すること。
